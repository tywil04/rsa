...
class rsa:
    ...
    def encrypt(publicKey: int, plainText: str) -> None:
    ...
    def decrypt(privateKey: int, cipherText: str) -> None:
...
publicKey, privateKey = rsa.generateKeyPair(); # Generate keypair
